...
--
-- Host: localhost    Database: quan_ly_nhan_khau_nhom12
-- ------------------------------------------------------
...
INSERT INTO `duoc_nhan_thuong` VALUES (1,1,'Học sinh giỏi',_binary '','A',1000000,_binary ''),(1,2,'Học sinh giỏi',_binary '','A',1000000,_binary ''),(1,3,'Học sinh giỏi',_binary '','A',1000000,_binary ''),(1,4,'Học sinh khá',_binary '','B',700000,_binary ''),(2,1,'Học sinh khá',_binary '','B',700000,_binary ''),(2,2,'Học sinh giỏi',_binary '','A',1000000,_binary ''),(2,3,'Học sinh giỏi',_binary '','A',1000000,_binary ''),(2,4,'Học sinh giỏi',_binary '','B',700000,_binary '\0'),(3,1,'Học sinh giỏi, giải thành phố',_binary '','A',1300000,_binary '\0'),(3,2,'Học sinh giỏi',_binary '','A',1000000,_binary '\0'),(3,3,NULL,_binary '\0',NULL,NULL,_binary '\0'),(3,4,NULL,_binary '\0',NULL,NULL,_binary '\0');
...
-- Dump completed on 2020-12-07 23:02:03
